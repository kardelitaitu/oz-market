  ...
  <div class="header-inner">
    ...
    <div class="header-right">
      <div class="header-right-row">
        <ThemeSwitcher />
        <button type="button" class="auth-btn signin">Sign In</button>
        <button type="button" class="auth-btn signup">Sign Up</button>
      </div>
      <BackgroundSwitcher />
    </div>
  </div>
  ...
  <div class="footer-inner">
    ...
    <div class="footer-social">
      <div class="social-icons">
        ...
        <button type="button" aria-label="Discord">
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
        ...
        <button type="button" aria-label="Medium">
