        ...
        App::new()
            ...
            .service(
                web::scope("/internal/v1")
                    ...
                    .route("/reviews/{review_id}/approve", web::post().to(crate::http::actix_handlers::approve_review))
                    .route("/reviews/{review_id}/reject", web::post().to(crate::http::actix_handlers::reject_review))
            )
